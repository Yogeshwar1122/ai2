  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative" style={{ background: '#030303' }}>
      ...
      <div className="w-full max-w-md relative">
        <button data-testid="pin-back-button" onClick={onBack} className="flex items-center gap-2 text-[#9CA3AF] hover:text-[#10B981] font-mono text-xs mb-6 transition-colors">
        ...
        <div className="terminal-card p-6 sm:p-8 animate-fade-in" data-testid="pin-verify-card">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 border border-[#10B981]/40 rounded-sm mb-4 bg-[#0A0A0A]">
              <NumberSquareNine size={28} weight="duotone" className="text-[#10B981] glow-green" />
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              <input
                ...
                className="w-full text-center text-2xl font-mono bg-[#0A0A0A] border border-[#10B981]/20 rounded-sm text-[#00FF41] p-4 focus:border-[#10B981] focus:shadow-[0_0_10px_rgba(16,185,129,0.3)] outline-none tracking-[0.5em]"
                placeholder="****"
              />
            </div>
